...
import one_two_genes_functions
...
# Initial conditions
circuit_filename_linear = 'circuit_linear_2.csv'
...
environment_filename = 'environment_stall.csv'
...
circuit_lin_tan.name = circuit_lin_tan.name + '_tandem_linear_stall'
circuit_lin_tan.log.name = circuit_lin_tan.name
circuit_lin_dir.name = circuit_lin_dir.name + '_divergent_linear_stall'
circuit_lin_dir.log.name = circuit_lin_dir.name
circuit_lin_con.name = circuit_lin_con.name + '_convergent_linear_stall'
circuit_lin_con.log.name = circuit_lin_con.name
# ---------------------------------------------------------
# Tandem case
# ---------------------------------------------------------
one_two_genes_functions.run_simulation_two_genes(circuit_lin_tan, add_time)
...
# Divergent case
# ---------------------------------------------------------
one_two_genes_functions.run_simulation_two_genes(circuit_lin_dir, add_time)
...
# Convergent case
# ---------------------------------------------------------
one_two_genes_functions.run_simulation_two_genes(circuit_lin_con, add_time)
