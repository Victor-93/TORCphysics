...
# Script
# **********************************************************************************************************************
# It seems we need this statement when in Windows
if __name__ == "__main__":
    ...
    # **********************************************************************************************************************
    # Calculate time and number of frame
    time = np.arange(initial_time, final_time + dt, dt)
    frames = len(time)

    # Info about the total numer of simulations
    ...
    for dist1, intergene_length, dist2, gene_length, g1_promoter, g2_promoter in product(
        ...
        for simulation_number in range(n_simulations):
            Item = {'simulation_number': simulation_number,
                    'frames': frames, 'dt': dt, 'sigma0': sigma0,
