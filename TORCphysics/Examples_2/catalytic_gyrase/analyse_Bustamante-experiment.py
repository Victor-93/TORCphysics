...
rotations_dist = [x for xs in best_case['rotations_distribution'] for x in xs]

sns.histplot(rotations_dist, kde=True, ax=axs[0], bins=10, binrange=(-5, 0), color=hist_color, stat='probability')
...
#axs[0, 2].plot(f,p_cycles)
#axs[1,2].set_xlabel('Force (pN)', fontsize=xlabel_size)
...
#axs[1,2].set_ylabel('N cycles', fontsize=xlabel_size)
