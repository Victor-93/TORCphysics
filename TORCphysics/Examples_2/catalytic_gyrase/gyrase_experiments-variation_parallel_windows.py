...
def objective_function(params):
    # In the windows parallel version, we have to move everything inside, because the way hyperopt works, it
    # seems that it doesn't allow us to pass other inputs, so in this version we define everything inside the module.
