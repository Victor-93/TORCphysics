...
n_simulations = 4#60#84  # 60 #48 #120
tests = 10 #400#100 #400  # 10  # 100  # number of tests for parametrization
...
threshold_min_topoI = 0.001 #-0.05
threshold_max_topoI = 0.05 #-0.001
...
gyrase_df['sigma0'] = sigma_f_gyrase #best_df['sigma0_gyrase']
