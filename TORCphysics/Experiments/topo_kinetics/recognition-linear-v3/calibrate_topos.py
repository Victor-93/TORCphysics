...
# In this version, I will mantained fixed the ratio of the threshold and width of gyrase binding so it is
# 30% active when the DNA is relaxed. Here, the threshold is coupled to the width by log(7/3)
# ----------------------------------------------------------------------------------------------------------------------
# Initial conditions
# ----------------------------------------------------------------------------------------------------------------------
# Units:
...
n_simulations = 2#128  # 60 #48 #120
tests = 2#1100 #400  # 10  # 100  # number of tests for parametrization
...
# Gyrase ranges
ratio_tw = -np.log(7./3.)  # The threshold is coupled to the with as threshold = ratio_tw * width
...
width_max_gyrase = 0.05 #.05  # 1.0
#threshold_min_gyrase = 0.0 #0.001
#threshold_max_gyrase =  0.1  # 0.1  # 1.0
...
def objective_function(params):
    ...
    # Gyrase
    thresh = ratio_tw * params['width_gyrase']
    name = gyrase_name
