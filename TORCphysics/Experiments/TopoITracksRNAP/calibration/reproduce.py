...
frames = len(time)
file_out = 'avgx2-reproduce-02-calibration_RNAPTracking_nsets_p2_small_dt'+str(dt)

# These ones have the best parametrisation
topo_best = '../analysis/avgx2_topoI_dt'+str(dt)+'.csv'
RNAP_best = '../analysis/avgx2_RNAP_dt'+str(dt)+'.csv'

# Reference - It is the reference density of topos when there is no gene that we will use to calculate the
#             fold enrichment.
# --------------------------------------------------------------
reference_path = '../preprocess/avg_'  # Path with the reference kdes
...
topoI_params_csv = '../../Topokinetics/analysis/avg_dt1.0_topoI.csv'
