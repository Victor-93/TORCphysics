...
pickle_files = [
    '../calibration/avgx2-reproduce-calibration_RNAPTracking_nsets_p2_small_dt'+str(dt)+'.pkl'
]
...
sites_filename = '../calibration/sites.csv'
enzymes_filename = None
environment_filename = '../calibration/environment.csv'
series = True
continuation = False
