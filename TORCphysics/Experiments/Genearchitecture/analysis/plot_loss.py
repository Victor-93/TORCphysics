...
loss_files = [
    ...
    {**{pm: f"../calibration/sus_genearch_V0-01-{pm}_gamma0.05_dt1.0-values.csv" for pm in promoter_cases},
     'label': 'V0'},

    # genearch_V1 - gamma 0.1
    {**{pm: f"../calibration/sus_genearch_V1-01-{pm}_gamma0.1_dt1.0-values.csv" for pm in promoter_cases}, 'label': 'V1'},

    # genearch_V2
    {**{pm: f"../calibration/sus_genearch_V2-01-{pm}_dt1.0-values.csv" for pm in promoter_cases}, 'label': 'V2'}
]
