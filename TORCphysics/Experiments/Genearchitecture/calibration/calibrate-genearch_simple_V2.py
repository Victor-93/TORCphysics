...
# --------------------------------------------------------------
tests = 1500#10 #100  # number of tests for parametrization
...
RNAP_filename = '../../TopoITracksRNAP/analysis/avgx2_RNAP_dt1.0.csv'
...
for i, promoter_case in enumerate(promoter_cases):
    ...
    if susceptibility_based:
        exp_df = pd.read_csv(susceptibility_files[i])
    else:
