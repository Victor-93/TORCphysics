...
n_simulations = 100
tests = 200  # 00  # number of tests for parametrization
...
#  Write dictionary file (should be .pkl)
with open(topoI_out+'.pkl', 'wb') as fp:
...
#  Write dictionary file (should be .pkl)
with open(gyrase_out+'.pkl', 'wb') as fp:
    pickle.dump(gyrase_best, fp)
    print('dictionary saved successfully to file')
