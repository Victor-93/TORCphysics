...
topoI_effect_model_name = 'TopoISimpleTorque'
...
def topoI_objective_function(params):
    ...
    #effect_oparams = {'k_DNA': float(params['k_DNA'][0])}
    effect_oparams = {'k_DNA': float(params['k_DNA'][0]), 'drag_constant': float(params['drag_constant'][0])}
...
axs[0].set_title('Topoisomerase I: Poisson + Simple Torque')
